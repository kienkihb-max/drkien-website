...
const CAN_CHEP = [
  ...
  "bai-viet.css",
  // File này còn chạy phía trình duyệt và cần window.THONG_TIN, do
...
//
// Có mặt là để seo-schema.js — script duy nhất còn chạy phía trình duyệt và
// cần dữ liệu này — đọc được thông tin phòng khám qua window.THONG_TIN.
(function () {
